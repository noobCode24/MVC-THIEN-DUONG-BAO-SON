<div class="wrapper">
    ...
    <div class="banner_ticket">
        ...
        <div class="ticket-selection">
            <div class="ticket">
                <img src="<?php echo _HOST_PATH_ ?>\public\assets\clients\images\book_tickets_img\ticket_1-3.png" alt="Ticket 1">
                <span id="ticketId" style="display: none;">1</span>

                <div class="ticket-details">
                    <div class="content-ticket">
                        <p><i class="fas fa-ticket-alt"></i>Vé tham quan khách cao từ 1m - 1,3m</p>
                    </div>
