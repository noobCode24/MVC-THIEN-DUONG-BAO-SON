        ...
        <form action="<?php echo _HOST_PATH_ ?>/admin/Account/postEditAccount/un=<?php echo $dataAcc['username'] ?>" method="post" class="w-50">
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo $dataAcc['username'] ?>" type="text" name="username" id="" class="form-control" placeholder="Nhập tên đăng nhập">
                </div>
                <div class="mb-3">
                    <label for="">Mật khẩu</label>
                    <input value="<?php echo $dataAcc['pass_real'] ?>" type="text" name="password" id="" class="form-control" placeholder="Nhập mật khẩu">
                </div>
                <div class="mb-3">
                    <label for="">Nhập lại mật khẩu</label>
                    <input value="<?php echo $dataAcc['pass_real'] ?>" type="text" name="password" id="" class="form-control" placeholder="Nhập lại mật khẩu">
                </div>
            </div>
            <!-- <div class="mb-3 mt-3">
