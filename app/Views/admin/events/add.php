    ...
    <div class="mt-4 field-input d-flex justify-content-center align-items-center">
        <form action="<?php echo _HOST_PATH_ ?>/admin/Events/postAddEvent" method="post" class="w-50" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" name="event_title" id="" class="form-control" placeholder="Nhập tên tiêu đề">
            </div>
            <div class="mb-3">
                <label for="">Nội dung</label>
                <textarea style="height: 80px;" name="event_desc" id="" placeholder="Nhập mô tả" class="form-control"></textarea>
            </div>
            <div class="mb-3">
                <label for="">Mô tả</label>
                <textarea style="height: 80px;" name="event_content" id="" placeholder="Nhập nội dung" class="form-control"></textarea>
            </div>
            <div class="mb-3">
                <label for="">Ảnh</label>
